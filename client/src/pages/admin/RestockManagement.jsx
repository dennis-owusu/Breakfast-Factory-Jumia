...
const RestockManagement = () => {
  ...
  const fetchRestockRequests = async () => {
    try {
      setLoading(true);
      const response = await fetch('https://breakfast-factory-jumia.onrender.com/api/route/all');
  ...
  const handleProcessRequest = async (requestId, status, adminNote) => {
    try {
      ...
      const response = await fetch(`https://breakfast-factory-jumia.onrender.com/api/route/process/${requestId}`, {
        method: 'PUT',
        headers: {
